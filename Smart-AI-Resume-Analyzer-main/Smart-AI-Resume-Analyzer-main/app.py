...
#             # "📝 RESUME BUILDER": self.render_builder,     # updated
#             "📊 DASHBOARD": self.render_dashboard,
#             # "🎯 JOB SEARCH": self.render_job_search,      # updated
#             # "💬 FEEDBACK": self.render_feedback_page,     # updated
...
#                 else:
#                     resume_text = self.extract_text_from_docx(uploaded_file)
...
#     # Updated Code
#     # Function to save job roles to JSON
...
#         # analysis_result = self.analyze_resume(role_info["description"], role_info["required_skills"], role_info["recommended_skills"])
...
#         #         st.session_state.user_role = "Default Role"
#         #     if "user_description" not in st.session_state:
#         #         st.session_state.user_description = "Enter job description here..." 

#         # # User input fields 
#         #     new_role = st.text_input("Enter Role", st.session_state.user_role)
#         #     new_description = st.text_area("Enter Job Description", st.session_state.user_description)
#         #     st.session_state.user_role = new_role
#         #     st.session_state.user_description = new_description
        
#         # updated code1 ends here
...
class ResumeApp:
    ...
    def render_about(self):
        ...
        # 124852522.jpeg
        # Get image path and convert to base64
        image_path = os.path.join(os.path.dirname(__file__), "assets", "thirumoolaritsolutions_logo.jpg")
        image_base64 = get_image_as_base64(image_path)
        ...
        st.markdown(f"""
            <div class="profile-section">
                <img src="{image_base64 if image_base64 else 'https://github.com/akash25600'}" 
                     alt="Akash P" 
                     class="profile-image"
                     onerror="this.onerror=null; this.src='https://github.com/akash25600';">
                <h2 class="profile-name">THIRUMOOLAR IT SOLUTIONS</h2>
                <p class="profile-title">Crafting innovative technology that transforms the world for the better.</p>
                <div class="social-links">
                    <a href="https://github.com/akash25600" class="social-link" target="_blank">
                        <i class="fab fa-github"></i>
                    </a>
                    <a href="https://www.linkedin.com/company/thirumoolaritsolutions/posts/?feedView=all" class="social-link" target="_blank">
                        <i class="fab fa-linkedin"></i>
                    </a>
                    <a href="mailto:hunterdii9879@gmail.com" class="social-link" target="_blank">
                        <i class="fas fa-envelope"></i>
                ...
                <p class="bio-text">
                    TMIS Company specializes in developing, producing, and selling a diverse range of software products and services. Our expertise includes creating and distributing:
                    SaaS (Software as a Service) applications, Mobile applications, B2B (Business-to-Business) and B2C (Business-to-Consumer) applications Customized software solutions for various industrial challenges
                </p>
            </div>
        """, unsafe_allow_html=True)
